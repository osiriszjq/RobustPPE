...
from pointnet_pyt.pointnet.model_MLP3BN import PointNetCls
from all_utils import DATASET_NUM_CLASS

class PointNetMLP3BN(nn.Module):
    ...
    def forward(self, pc):
        pc = pc.to(next(self.parameters()).device).transpose(2, 1).float()
...
class PointNetMLP3BNMean(nn.Module):
